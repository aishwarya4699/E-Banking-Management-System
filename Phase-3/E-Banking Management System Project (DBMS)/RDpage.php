...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo">New Recurring Deposits</h1>
  <p class="w3-xlarge"></p>
  ...
  <div class="w3-content">
    <div class="w3-twothird">
      ...
      <p class="w3-text-grey">
          <form method="post" action="RDpage.php">
		  <?php include('error.php'); ?>
                <h1><u>RD details</u></h1>
				<p><h2>Deposit user_id:</h2></p>
                ...
                <br>
                <h2><input type="submit" class="btn" name="reg_user">Submit</h2>
